...
`codex_client` is a lightweight WebSocket client (packaged as a Codex skill) that connects to a running `codex app-server` instance. It enables Codex agents to delegate tasks to Codex via persistent, multi-turn WebSocket sessions using JSON-RPC 2.0.
...
- [skills/codex-ws-client/SKILL.md](skills/codex-ws-client/SKILL.md) — skill descriptor used by Codex
